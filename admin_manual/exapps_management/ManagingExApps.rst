...
Command: ``app_api:app:register [--force-scopes] [--info-xml INFO-XML] [--json-info JSON-INFO] [--wait-finish] [--silent] [--test-deploy-mode] [--env [ENV]] [--mount [MOUNT]] [--port [PORT]] [--] <appid> [<daemon-config-name>]``
...
***********************
    ...
    * ``--port`` *[optional]* - Optional port mapping OPTIONAL_HOST_IP;HOST_PORT;CONTAINER_PORT (e.g. 443;9443/tcp, 0.0.0.0;80;8080/udp) (multiple values allowed)
